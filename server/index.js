...
function getDraftSecret() {
	return "b87c487a-87a5-4fa9-8466-2ec699041fc3";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "2955b6e8-3730-4fb4-8666-8f3bde0911ba";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "2955b6e8-3730-4fb4-8666-8f3bde0911ba") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "2955b6e8-3730-4fb4-8666-8f3bde0911ba",
		rootBoundaryId
	});
}
/**
