...
function getDraftSecret() {
	return "64dad7fe-9af3-4541-8143-86982df66acf";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "700f59f0-1e8f-4cd8-9d55-aff49f0115d9";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "700f59f0-1e8f-4cd8-9d55-aff49f0115d9") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "700f59f0-1e8f-4cd8-9d55-aff49f0115d9",
		rootBoundaryId
	});
}
/**
