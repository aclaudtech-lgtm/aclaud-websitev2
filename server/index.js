...
function getDraftSecret() {
	return "0bbe14db-4fdd-4dea-9547-f38afee6445f";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "eb01916c-7e7d-407c-9d20-5ef92d8b0265";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "eb01916c-7e7d-407c-9d20-5ef92d8b0265") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "eb01916c-7e7d-407c-9d20-5ef92d8b0265",
		rootBoundaryId
	});
}
/**
